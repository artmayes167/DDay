...
+ (NSDate *)getHoursRoundedForDate:(NSDate *) givenDate{
    NSDateComponents *components = [[NSDate currentCalendar] components:componentFlags fromDate:givenDate];
    ...
    NSDate *newDate = [[NSDate currentCalendar] dateFromComponents:components];
    return newDate;
}
